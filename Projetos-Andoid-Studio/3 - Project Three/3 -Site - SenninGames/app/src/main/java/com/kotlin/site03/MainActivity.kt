...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val webViewTutorials = findViewById<WebView>(R.id.webviewSenninGames)


        webViewTutorials.webViewClient = WebViewClient()  // ->  Adiciona um WebViewClient para que a WebView carregue a URL
        webViewTutorials.loadUrl("https://www.senningames.com/") // -> Carrega a URL
